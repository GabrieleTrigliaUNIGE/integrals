...
/*! \brief computes the output value of a polynomial
    ...
    \param size length of the coeff array (deg of poly)
...
/*! \brief numerical integration according to the rectangular rule
    ...
    \param integ1 integral computed using as reference the first point of each interval (per difetto)
    \param integ2 integral computed using as reference the second point of each interval (per eccesso)
*/
